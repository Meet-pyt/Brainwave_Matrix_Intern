...
class employeeClass:
    def __init__(self,root):
        ...
        self.var_doj=StringVar() #doj-date of joining
        self.var_email=StringVar()
        self.var_pass=StringVar()
        self.var_utype=StringVar() #utype= user type 
        self.var_salary=StringVar()

        #===Search Frame===#
        SerachFrame=LabelFrame(self.root,text="Serach Employee",font=("goudy old style",12,"bold"),bd=2,relief=RIDGE,bg="white")
        SerachFrame.place(x=250,y=20,width=600,height=70)

        #===Options===#
        cmb_search=ttk.Combobox(SerachFrame,textvariable=self.var_searchby,values=("Select","Email","Name","Contact"),state='readonly',justify=CENTER,font=("goudy old style",15))
...
#===============================FUNCTIONS====================================================================================================================================================================#
        ...
        try:
            if self.var_emp_id.get() == '':
                ...
                if row==None:
                    ...
                    confirm= messagebox.askyesno("Confirm", "Are you sure you want to delete this employee?", parent=self.root)
                    if confirm==True:
    ...
    def clear(self):
            ...
            self.txt_address.delete('1.0', END)# Clear the text area for address
            self.var_salary.set("") 
