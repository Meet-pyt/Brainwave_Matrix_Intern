...
class BillClass:
    def __init__(self,root):
        ...
        lbl_note=Label(productFrame1,text="Note:'Enter 0 quntity to remove product from the cart'",font=("goudy old style",12),anchor='w',bg="white",fg="red").pack(side=BOTTOM,fill=X)
        ...
        self.txt_cal_input=Entry(cal_frame,textvariable=self.var_cal_input,font=('arial',15,"bold"),width=21,bd=10,relief=GROOVE,justify=RIGHT)
        ...
        billFrame.place(x=953,y=110,width=700,height=410)

        bTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="#FF3632",fg="white").pack(side=TOP,fill=X)  
        ...
        billMenuFrame.place(x=953,y=520,width=700,height=140)

        self.lbl_amnt=Label(billMenuFrame,text="Bill Amounnt\n[0]",font=("goudy old style",15,"bold"),cursor="hand2",bg="#3f51b5",fg="white")
        self.lbl_amnt.place(x=2,y=5,width=150,height=70)

        self.lbl_discount=Label(billMenuFrame,text="Discount \n[5%]",font=("goudy old style",15,"bold"),cursor="hand2",bg="#8bc34a",fg="white")
        self.lbl_discount.place(x=170,y=5,width=160,height=70)

        self.lbl_net_pay=Label(billMenuFrame,text="Net Pay\n[0]",font=("goudy old style",15,"bold"),cursor="hand2" ,bg="#607d8b",fg="white")
        self.lbl_net_pay.place(x=346,y=5,width=260,height=70)

        btn_print=Button(billMenuFrame,text="Print",command=self.print_bill,font=("goudy old style",15,"bold"),cursor="hand2",bg="lightgreen",fg="white")
        btn_print.place(x=2,y=80,width=150,height=50)

        btn_lbl_clear_all=Button(billMenuFrame,text="Clear All",command=self.clear_all,font=("goudy old style",15,"bold"),cursor="hand2",bg="gray",fg="white")
        btn_lbl_clear_all.place(x=170,y=80,width=160,height=50)

        btn_lbl_generate=Button(billMenuFrame,text="Generate/Save Bill",command=self.generate_bill,font=("goudy old style",15,"bold"),cursor="hand2",bg="#009688",fg="white")
        btn_lbl_generate.place(x=346,y=80,width=260,height=50)


        #===Footer===#
        footer=Label(self.root,text="IMS-Inventory Management System | GUI Interface\nFor any Technical Issue Contact: 987xxxxx01",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
{str("="*47)}\n
    ...
    def print_bill(self):
        if self.chk_print==1:
            ...
            messagebox.showerror('Print',"Please generate bill, to print the recepit",parent=self.root)
