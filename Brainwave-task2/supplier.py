...
#==============================================FUNCTIONS====================================================================================================================================================#
        ...
        try:
            if self.var_sup_invoice.get() == '':
                ...
                if row==None:
                    ...
                    confirm= messagebox.askyesno("Confirm", "Are you sure you want to delete this supplier?", parent=self.root)
                    if confirm==True:
    ...
    def clear(self):
            ...
            self.txt_desc.delete('1.0', END)# Clear the text area for address
